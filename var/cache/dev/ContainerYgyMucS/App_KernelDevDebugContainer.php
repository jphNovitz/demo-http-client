...
class App_KernelDevDebugContainer extends Container
{
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'screen_name': $value = $this->getEnv('SCREEN_NAME'); break;
            case 'count': $value = $this->getEnv('COUNT'); break;
            case 'bearer': $value = $this->getEnv('BEARER'); break;
            case 'email_to': $value = $this->getEnv('CONTACT_TO_EMAIL'); break;
